<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
  ...
  <h1 class="text-3xl font-bold mb-4 text-black dark:text-white">🔄 useEffect + fetch (with Loading & Error)</h1>
  ...
  <h2 class="text-2xl font-semibold mb-4 text-black dark:text-white">🛠️ Full Example with Loading & Error Handling</h2>
...
export default UsersList;
  ...
  <h2 class="text-2xl font-semibold mb-4 text-black dark:text-white">🔍 Explanation</h2>

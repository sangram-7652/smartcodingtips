...
function Counter() {
  ...
  <a href="<?= base_url('react/context-api') ?>" class="hover:underline">← Previous: Context API</a>
  <a href="<?= base_url('react/zustand') ?>" class="hover:underline ms-auto">Next: Zustand →</a>
</div>

<?php
$title = "CSS BEM Naming Convention | SmartCodingTips";
$description = "Organize your CSS classes using the BEM naming convention for scalable code.";
$keywords = "css bem, block element modifier, css naming convention, structured css";
?>

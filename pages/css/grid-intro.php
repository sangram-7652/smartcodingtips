...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">To start using grid, apply <code>display: grid;</code> to the container element:</p>
...
.container {
    display: grid;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>grid-template-columns</code> and <code>grid-template-rows</code> to define structure:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
.container {
    display: grid;
    ...
    grid-template-rows: auto 1fr auto;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>gap</code> (or <code>row-gap</code> and <code>column-gap</code>) to create spacing between grid items:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
.container {
    display: grid;
    gap: 20px;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">You can place items in specific grid areas using line numbers:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
.item {
    ...
    grid-row: 2 / 4;     /* spans row 2 to 3 */
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>repeat()</code> to simplify repeated values:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
.container {
    grid-template-columns: repeat(3, 1fr);
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Create responsive grids with flexible columns:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
.container {

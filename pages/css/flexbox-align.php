...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Flexbox uses <code>justify-content</code> and <code>align-items</code> to control alignment:</p>
...
.flex-container {
    ...
    align-items: center;       /* vertical */
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">CSS Grid uses similar properties to control alignment:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
.grid-container {
    display: grid;
    ...
    align-items: center;       /* aligns items vertically */
            ...
            <p class="text-lg mt-2">You can also align the whole grid content:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
.grid-container {
    ...
    align-content: center;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>align-self</code> or <code>justify-self</code> for specific item control:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
.item {
    align-self: flex-end;
    justify-self: start;

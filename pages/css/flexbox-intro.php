...
@media (max-width: 767px) {
    ...
    <div><a href="<?= base_url('css/breakpoints') ?>" class="text-blue-600 dark:text-blue-400 hover:underline">← Previous: Breakpoints</a></div>
    <div><a href="<?= base_url('css/flexbox-align') ?>" class="text-blue-600 dark:text-blue-400 hover:underline">Next: Aligning Items →</a></div>
</div>

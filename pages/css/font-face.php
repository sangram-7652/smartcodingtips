...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Visit <a href="https://fonts.google.com" class="text-blue-600 hover:underline" target="_blank">Google Fonts</a>, choose a font, and include the provided link in your HTML <code>&lt;head&gt;</code>:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
&lt;link href="https://fonts.googleapis.com/css2?family=Roboto&display=swap" rel="stylesheet"&gt;
            </code></pre>
            <p class="text-lg mt-2">Then use it in your CSS:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
body {
    font-family: 'Roboto', sans-serif;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Host and load your own font files with <code>@font-face</code>:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">
@font-face {
...
h1 {
    font-family: 'MyCustomFont', sans-serif;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Different browsers support different font formats. Common ones include:</p>

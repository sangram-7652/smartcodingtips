...
&lt;p&gt;This is a paragraph.&lt;/p&gt;
            ...
            <p class="text-lg mt-2">In this example, <code>&lt;p&gt;</code> is the opening tag and <code>&lt;/p&gt;</code> is the closing tag.</p>
        </section>
...
&lt;h1&gt;Welcome&lt;/h1&gt;
            ...
            <p class="text-lg mt-2">Here, the entire structure is an <strong>element</strong>.</p>
        </section>
...
&lt;br&gt; &lt;img src="image.jpg" alt="Sample image"&gt;
            ...
            <p class="text-lg mt-2">These are called empty elements.</p>
        </section>
...
&lt;p&gt;This is a &lt;strong&gt;bold&lt;/strong&gt; word.&lt;/p&gt;
        ...
        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="attributes.php" class="text-blue-600 hover:underline">HTML Attributes →</a></p>
        </div>
    </article>
</main>

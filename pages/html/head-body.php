...
&lt;/body&gt;
    ...
    <div><a href="<?= base_url('html/doctype') ?>" class="text-blue-600 dark:text-blue-400 hover:underline">← Previous: Doctype Declaration</a></div>
    <div><a href="<?= base_url('html/comments') ?>" class="text-blue-600 dark:text-blue-400 hover:underline">Next: Comments in HTML →</a></div>
</div>
    </article>
</main>

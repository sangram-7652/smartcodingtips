<?php
$title = "Types of Lists | SmartCodingTips";
$description = "Learn about types of lists in HTML. Understand key concepts, examples, and usage.";
$keywords = "types, of, lists, html tutorial, html basics";
?>
...
&lt;/ul&gt;
    ...
    <a href="<?= base_url('html/iframe') ?>" class="text-blue-600 dark:text-blue-400 hover:underline">← Previous: iFrames</a>
    <a href="<?= base_url('html/create-table') ?>" class="text-blue-600 dark:text-blue-400 hover:underline ms-auto">Next: Creating Tables →</a>
</div>
    </article>
</main>

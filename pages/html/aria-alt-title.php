...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class="mb-2 text-lg">Used with images to describe their content when the image cannot be displayed or is read by screen readers.</p>
...
&lt;img src="logo.png" alt="Smart Coding Tips Logo"&gt;
        ...
        <section class="mb-6">
            ...
            <p class="mb-2 text-lg">Displays a tooltip when the user hovers over an element. It also provides additional info for screen readers.</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto"><code class="text-sm">

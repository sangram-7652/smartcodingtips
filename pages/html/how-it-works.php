...
&lt;/html&gt;
            ...
            <p class="text-lg mt-2">This code creates a simple HTML page with a heading and a paragraph. The browser uses HTML tags to determine what and how to display elements.</p>
        </section>
        ...
        <section class="mb-6">
            ...
            <p class="text-lg">HTML is more than markup—it's the language that gives structure to every online experience. Knowing how it works unlocks the power to create, style, and script the web effectively.</p>
        </section>

        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="html.php?page=html/first-page" class="text-blue-600 hover:underline">Your First Html Page →</a></p>
        </div>
    </article>
</main>

<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
  ...
  <pre class="bg-gray-100 p-4 overflow-x-auto rounded mb-4 text-sm dark:bg-gray-800 dark:text-white"><code>// utils.js
...
console.log(add(2, 3));</code></pre>
  ...
  <pre class="bg-gray-100 p-4 overflow-x-auto rounded mb-4 text-sm dark:bg-gray-800 dark:text-white"><code>// greet.js
...
console.log(greet("Alice"));</code></pre>
  ...
  <pre class="bg-gray-100 p-4 overflow-x-auto rounded mb-4 text-sm dark:bg-gray-800 dark:text-white"><code>// mix.js
...
import sayHi, { name } from './mix.js';</code></pre>
  ...
  <pre class="bg-gray-100 p-4 overflow-x-auto rounded mb-4 text-sm dark:bg-gray-800 dark:text-white"><code>&lt;script type="module" src="main.js"&gt;&lt;/script&gt;</code></pre>
 ...
 <div class="mt-4 flex justify-between  items-center flex-wrap gap-4  text-blue-600 dark:text-blue-400 font-semibold">
    <a href="<?= base_url('js/default-params') ?>" class="hover:underline">← Previous: Default Params</a>
    <a href="<?= base_url('js/modern-practice') ?>" class="hover:underline ms-auto">Next: Modern Code Examples →</a>
</div>
</main>

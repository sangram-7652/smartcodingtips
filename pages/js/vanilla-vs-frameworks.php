<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
  ...
  <h1 class="text-3xl font-bold mb-4">🆚 Vanilla JavaScript vs Frameworks</h1>
  ...
  <h2 class="text-2xl font-semibold mt-6 mb-2">🍦 What is Vanilla JavaScript?</h2>
  <p class="mb-4">
    "Vanilla JS" refers to using plain JavaScript — without any libraries or frameworks. It gives you direct control over the DOM, browser APIs, and your code structure.
  </p>

  <h3 class="text-lg font-semibold mt-4">✅ Pros:</h3>
  ...
  <h3 class="text-lg font-semibold">⚠️ Cons:</h3>
  <ul class="list-disc list-inside mb-4">
  ...
  <h2 class="text-2xl font-semibold mt-6 mb-2">⚙️ What Are Frameworks?</h2>
  <p class="mb-4">
    Frameworks like React, Vue, and Angular are tools that simplify building modern web apps. They provide components, state management, routing, and more — reducing the amount of manual DOM manipulation you need to do.
  </p>
  ...
  <h2 class="text-2xl font-semibold mt-6 mb-2">🧠 When to Use Vanilla JS</h2>
  <ul class="list-disc list-inside mb-4">
  ...
  <h2 class="text-2xl font-semibold mt-6 mb-2">🚀 When to Use Frameworks</h2>
  <ul class="list-disc list-inside mb-4">

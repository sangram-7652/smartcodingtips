...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
        <ol class="list-none p-0 inline-flex">
            ...
            <li class="flex items-center">
                <a href="javascript.php?page=js/operators" class="text-blue-600 dark:text-blue-400 hover:underline">JavaScript Operators</a>
            </li>
        </ol>
    </nav>
    ...
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>let x = 10;
let y = 3;
...
x ** y // 1000 (Exponentiation)</code></pre>
    ...
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>let a = 5;
...
a %= 4;  // a = a % 4 => 1</code></pre>
    ...
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>5 == '5'   // true (loose equality)
...
3 &lt;= 2     // false</code></pre>
    ...
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>true && true   // true
true && false  // false
true || false  // true
!true          // false</code></pre>
...
person instanceof Object  // true</code></pre>
    ...
    <a href="<?= base_url('js/data-types') ?>" class="hover:underline">← Previous: Data Types</a>
    <a href="<?= base_url('js/comments') ?>" class="hover:underline ms-auto">Next: Comments →</a>
</div>

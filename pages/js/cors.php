<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
  ...
  <pre class="bg-gray-100 p-4 rounded text-sm mb-4 overflow-x-auto"><code>// Example
fetch("https://api.example.com/data")
  ...
  <pre class="bg-green-100 p-4 rounded text-sm mb-4 overflow-x-auto"><code>const express = require("express");
...
app.use(cors({ origin: "https://your-frontend.com" }));</code></pre>
  ...
  <pre class="bg-green-100 p-4 rounded text-sm mb-4 overflow-x-auto"><code>header("Access-Control-Allow-Origin: *");

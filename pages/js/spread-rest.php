...
console.log(obj2); // { name: "Alice", age: 30 }</code></pre>
    ...
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>function sum(...nums) {
...
console.log(others); // { b: 2, c: 3 }</code></pre>
    ...
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>const numbers = [4, 5, 6];
console.log(Math.max(...numbers)); // 6</code></pre>
    ...
    <a href="<?= base_url('js/destructuring') ?>" class="hover:underline">← Previous: Destructuring</a>
    <a href="<?= base_url('js/modules') ?>" class="hover:underline ms-auto">Next: Modules: import/export →</a>
</div>
</main>

<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
  ...
  <pre class="bg-gray-100 p-4 rounded text-sm mb-4 overflow-x-auto"><code># Initialize project
npm init -y
...
npm install --save-dev jest</code></pre>
  ...
  <pre class="bg-gray-100 p-4 rounded text-sm mb-4 overflow-x-auto"><code>"scripts": {
  "test": "jest"
}</code></pre>
...
module.exports = add;</code></pre>
  ...
  <pre class="bg-gray-100 p-4 rounded text-sm mb-4 overflow-x-auto"><code>// math.test.js
...
test('adds 2 + 3 to equal 5', () => {
  ...
  <pre class="bg-gray-100 p-4 rounded text-sm mb-4 overflow-x-auto"><code>npm test</code></pre>
  ...
  <pre class="bg-gray-100 p-4 rounded text-sm mb-4 overflow-x-auto"><code>const fetchData = jest.fn(() => 'mocked data');

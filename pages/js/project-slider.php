<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
  ...
  <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
    <ol class="list-none p-0 inline-flex">
      ...
      <li class="flex items-center">
        <a href="javascript.php?page=js/project-slider" class="text-blue-600 dark:text-blue-400 hover:underline">Image Slider</a>
      </li>
    </ol>
  </nav>
  ...
  <pre class="bg-gray-100 p-4 overflow-x-auto rounded text-sm dark:bg-gray-800 dark:text-white mb-4"><code>&lt;div class="slider-container"&gt;
  &lt;div class="slides"&gt;
...
&lt;/div&gt;</code></pre>
  ...
  <pre class="bg-gray-100 p-4 overflow-x-auto rounded text-sm dark:bg-gray-800 dark:text-white mb-4"><code>.slider-container {
  position: relative;
  max-width: 700px;
  margin: auto;
  overflow: hidden;
...
.next { right: 0; }</code></pre>
  ...
  <pre class="bg-gray-100 p-4 overflow-x-auto rounded text-sm dark:bg-gray-800 dark:text-white mb-4"><code>const slides = document.querySelectorAll(".slide");
...
showSlide(currentSlide);</code></pre>
 ...
 <div class="mt-4 flex justify-between  items-center flex-wrap gap-4  text-blue-600 dark:text-blue-400 font-semibold">
    <a href="<?= base_url('js/csp') ?>" class="hover:underline">← Previous: Content Security Policy</a>
    <a href="<?= base_url('js/project-quiz-2') ?>" class="hover:underline ms-auto">Next: Advanced Quiz →</a>
</div>
</main>

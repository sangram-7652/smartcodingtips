...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
        <ol class="list-none p-0 inline-flex">
            ...
            <li class="flex items-center">
                <a href="javascript.php?page=js/dom-event-listeners" class="text-blue-600 dark:text-blue-400 hover:underline">Event Listeners</a>
            </li>
        </ol>
    </nav>
    ...
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>element.addEventListener("event", callbackFunction);</code></pre>

    <h2 class="text-2xl font-semibold mt-6 mb-2">🖱 Example: Click Event</h2>
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>document.getElementById("myBtn").addEventListener("click", function() {
    alert("Button was clicked!");
});</code></pre>

    <h2 class="text-2xl font-semibold mt-6 mb-2">💡 Using Named Functions</h2>
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>function greetUser() {
    console.log("Hello!");
}
...
document.querySelector("button").addEventListener("click", greetUser);</code></pre>
    ...
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>function sayHi() {
    alert("Hi!");
}
...
btn.removeEventListener("click", sayHi);</code></pre>
    ...
    <pre class="bg-gray-100 p-4 overflow-x-auto rounded dark:bg-gray-800 dark:text-white text-sm mb-4"><code>&lt;button id="myBtn"&gt;Click Me&lt;/button&gt;
...
&lt;/script&gt;</code></pre>
    ...
    <a href="<?= base_url('js/dom-update') ?>" class="hover:underline">← Previous: Changing Content</a>
    <a href="<?= base_url('js/dom-create') ?>" class="hover:underline ms-auto">Next: Creating/Removing Elements →</a>
</div>

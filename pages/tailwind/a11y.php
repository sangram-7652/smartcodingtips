...
&lt;button class="focus:outline-none focus:ring-2 focus:ring-blue-500"&gt;Submit&lt;/button&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg">
                Use sufficient contrast between background and text. Tailwind’s color palette is WCAG-friendly, but always test your combinations with tools like <a href="https://webaim.org/resources/contrastchecker/" target="_blank" class="text-blue-600 hover:underline">WebAIM Contrast Checker</a>.
            </p>
        </section>
...
&lt;div role="alert" aria-live="polite"&gt;New notification received&lt;/div&gt;
        ...
        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="tailwind.php?page=tailwind/performance" class="text-blue-600 hover:underline">Performance and SEO Tips →</a></p>
        </div>
    </article>
</main>

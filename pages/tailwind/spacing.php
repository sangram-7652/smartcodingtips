...
&lt;/div&gt;
            ...
            <p class="text-lg mt-2"><code>mx-auto</code> centers the container horizontally. <code>px-4</code> adds horizontal padding.</p>
        </section>

        <!-- Margin -->
        <section class="mb-6">
            <h2 class="text-2xl font-semibold mb-2">2. Margin Utilities</h2>
            <p class="text-lg mb-2">Use <code>m-</code>, <code>mt-</code>, <code>mb-</code>, <code>ml-</code>, <code>mr-</code>, and <code>mx-</code>/<code>my-</code> for margin control:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
...
&lt;div class="m-0"&gt;No margin&lt;/div&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>p-</code>, <code>pt-</code>, <code>pb-</code>, <code>pl-</code>, <code>pr-</code>, and <code>px-</code>/<code>py-</code> for padding:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
...
&lt;div class="px-6"&gt;Left and right padding&lt;/div&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">You can apply different spacing values for each breakpoint:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
&lt;div class="p-2 md:p-6 lg:p-10"&gt;Responsive padding changes with screen size&lt;/div&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>-m-</code> classes to pull elements closer together:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
&lt;div class="-mt-4"&gt;Moves element up by 1rem (mt-4 in reverse)&lt;/div&gt;
        ...
        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="tailwind.php?page=tailwind/sizing" class="text-blue-600 hover:underline">Widths, Heights, Max/Min →</a></p>
        </div>
    </article>
</main>

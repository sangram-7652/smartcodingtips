...
module.exports = {
  ...
  plugins: [],
            ...
            <p class="text-lg mt-2">As soon as a class appears in your content, JIT adds it to the output.</p>
        </section>
...
&lt;div class="w-[475px] bg-[#123456] text-[22px]"&gt;Custom Width, Color, and Font Size&lt;/div&gt;
        ...
        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="tailwind.php?page=tailwind/apply-layer" class="text-blue-600 hover:underline">@apply, @layer, and @variants →</a></p>
        </div>
    </article>
</main>

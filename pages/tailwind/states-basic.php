...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>hover:</code> to style elements when hovered:</p>
            <div class="mb-2">
...
&lt;/button&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>focus:</code> to style focused form elements:</p>
            <input type="text" placeholder="Focus me" class="border px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
        </section>

        <!-- Active State -->
        <section class="mb-6">
            <h2 class="text-2xl font-semibold mb-2">3. Active State</h2>
            <p class="text-lg mb-2">Use <code>active:</code> for when an element is pressed:</p>
            <div class="mb-2">
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>visited:</code> to change the style of links after visiting:</p>
            <a href="https://example.com" target="_blank" class="text-blue-600 visited:text-purple-600 underline">
                Visit Example.com
            </a>
        </section>
        ...
        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="tailwind.php?page=tailwind/states-group" class="text-blue-600 hover:underline">Group Hover & Focus Within →</a></p>
        </div>
    </article>
</main>

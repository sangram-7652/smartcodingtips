...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Tailwind provides predefined color classes like:</p>
...
&lt;div class="bg-blue-100 text-blue-800 p-4"&gt;Info box&lt;/div&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">You can change colors on interaction:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
...
&lt;/button&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">You can define your own palette in <code>tailwind.config.js</code>:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
// tailwind.config.js
module.exports = {
  theme: {
      ...
      colors: {
        brand: {
          ...
          dark: '#0057B8',
            ...
            <p class="text-lg mt-2">Then use it like this:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
&lt;div class="bg-brand text-white p-4"&gt;Brand Primary Background&lt;/div&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Tailwind supports color opacity using <code>/</code> notation:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
...
&lt;p class="text-blue-700/80"&gt;Faded blue text&lt;/p&gt;
        ...
        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="tailwind.php?page=tailwind/colors-bg" class="text-blue-600 hover:underline">Text and Background Colors →</a></p>
        </div>
    </article>
</main>

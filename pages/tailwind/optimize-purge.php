...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">In your <code>tailwind.config.js</code> file, set the `content` option like this:</p>
...
module.exports = {
  ...
  plugins: [],
            ...
            <p class="text-lg mt-2">This tells Tailwind to scan only those files for used class names.</p>
        </section>

        <!-- Build for Production -->
        <section class="mb-6">
            <h2 class="text-2xl font-semibold mb-2">3. Build CSS for Production</h2>
            <p class="text-lg mb-2">Use the Tailwind CLI or your build tool (PostCSS, Laravel Mix, Vite, etc.):</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm"><code>
npx tailwindcss -o build.css --minify
            </code></pre>
            <p class="text-lg mt-2">The <code>--minify</code> flag ensures the CSS is purged and compressed.</p>
        </section>
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Add dynamic or conditionally-used classes manually like this:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm"><code>
module.exports = {
  content: [...],
  safelist: [
    ...
    /^bg-(red|green|blue)-(100|200|300)$/,
        ...
        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="tailwind.php?page=tailwind/optimize-bloat" class="text-blue-600 hover:underline">Avoiding Bloat →</a></p>
        </div>
    </article>
</main>

...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class=" mb-2">Tailwind provides both combined and directional inset classes:</p>
  ...
  theme: {
    extend: {
      inset: {
        ...
        <div class="mt-4">
            <p class=" font-semibold">Next: <a href="tailwind.php?page=tailwind/z-index" class="text-blue-600 hover:underline">z-Index Utilities →</a></p>
        </div>
    </article>
</main>

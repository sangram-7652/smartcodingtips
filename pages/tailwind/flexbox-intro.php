...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
        <ol class="list-none p-0 inline-flex">
            ...
            <li class="flex items-center">
                <a href="tailwind.php?page=tailwind/flexbox-intro" class="text-blue-600 dark:text-blue-400 hover:underline">Flex Containers and Items</a>
            </li>
        </ol>
    </nav>
    ...
    <p class="mb-4">Tailwind CSS makes it super easy to work with Flexbox layouts using utility classes. You can turn any container into a flex container using the <code class="bg-gray-200 dark:bg-gray-900  px-1 rounded text-sm">flex</code> class.</p>

    <h2 class="text-2xl font-semibold mb-2">1️⃣ Creating a Flex Container</h2>
    <p class="mb-3">Use <code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">flex</code> to make a container flexible. By default, it lays children in a horizontal row.</p>
...
&lt;/div&gt;</code></pre>
    ...
    <p class="mb-3">Use <code class="bg-gray-200 dark:bg-gray-900 dark:bg-gray-900 px-1 rounded text-sm">inline-flex</code> instead of <code class="bg-gray-200 px-1 rounded text-sm">flex</code> if you want the container to behave like an inline element.</p>
...
&lt;/div&gt;</code></pre>
    ...
    <ul class="list-disc list-inside mb-6">
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">flex</code> – Turn container into a flexbox</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">inline-flex</code> – Same but inline</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">flex-row</code> – Items in a row (default)</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">flex-col</code> – Items stacked vertically</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">flex-wrap</code> – Allow items to wrap onto multiple lines</li>
    </ul>

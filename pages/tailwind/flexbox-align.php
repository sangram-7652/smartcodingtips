...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
        <ol class="list-none p-0 inline-flex">
            ...
            <li class="flex items-center">
                <a href="tailwind.php?page=tailwind/flexbox-align" class="text-blue-600 dark:text-blue-400 hover:underline">Justify Content & Align Items</a>
            </li>
        </ol>
    </nav>
    ...
    <ul class="list-disc list-inside mb-4">
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">justify-start</code>: align items at the start</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">justify-center</code>: center items</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">justify-end</code>: align at the end</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">justify-between</code>: even spacing between items</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">justify-around</code>: equal space around items</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">justify-evenly</code>: equal space between and around</li>
    </ul>
...
&lt;/div&gt;</code></pre>
    ...
    <ul class="list-disc list-inside mb-4">
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">items-start</code>: align items to top/left</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">items-center</code>: center items</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">items-end</code>: align to bottom/right</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">items-stretch</code>: stretch to fill (default)</li>
        <li><code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">items-baseline</code>: align text baselines</li>
    </ul>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="flex items-end space-x-2 h-32 bg-gray-100 dark:bg-gray-900 mb-6 p-2 rounded">
    ...
    <p>Use <code class="bg-gray-200 dark:bg-gray-900 dark:bg-gray-900 px-1 rounded text-sm">self-start</code>, <code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">self-end</code>, <code class="bg-gray-200 dark:bg-gray-900 px-1 rounded text-sm">self-center</code> etc. on individual flex items to override the container’s alignment.</p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="flex items-center h-32 bg-gray-100 dark:bg-gray-900 space-x-2 p-2 mb-6 rounded">

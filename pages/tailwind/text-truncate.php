...
&lt;/p&gt;
            ...
            <div class="mt-2">
                <p class="truncate w-64 bg-gray-800 text-white p-2 rounded border">This is a very long paragraph that will be truncated at one line with an ellipsis.</p>
            </div>
        </section>
...
&lt;/p&gt;
            ...
            <div class="mt-2 max-w-lg">
                <p class="line-clamp-3 bg-gray-800 text-white p-3 rounded border">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget turpis nec ipsum vulputate posuere. Suspendisse potenti. Curabitur tempus vehicula erat, a blandit lorem porta sit amet.
                </p>
            </div>
        </section>
...
plugins: [
  ...
  <a href="<?= base_url('tailwind/text-color') ?>" class="hover:underline">Next: Color Utilities and Custom Colors →</a>
</div>
    </article>
</main>

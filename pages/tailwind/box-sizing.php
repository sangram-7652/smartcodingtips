...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>float-left</code>, <code>float-right</code>, or <code>float-none</code> to control element float direction:</p>
...
&lt;div class="float-right w-1/2"&gt;Floated Right&lt;/div&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Control how elements avoid floated siblings using <code>clear-left</code>, <code>clear-right</code>, <code>clear-both</code>, or <code>clear-none</code>:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
&lt;div class="clear-both"&gt;This clears both sides&lt;/div&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>overflow-auto</code>, <code>overflow-hidden</code>, <code>overflow-scroll</code>, or <code>overflow-visible</code> to manage content that exceeds boundaries:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
...
&lt;/div&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use <code>object-cover</code>, <code>object-contain</code>, <code>object-fill</code>, and others to control how images and media scale within their container:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm">
&lt;img src="image.jpg" class="w-48 h-48 object-cover"&gt;
&lt;img src="image.jpg" class="w-48 h-48 object-contain"&gt;
            </pre>
            <p class="text-lg mt-2">These utilities work well with fixed-width containers for responsive images.</p>
        </section>
        ...
        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="tailwind.php?page=tailwind/box-sizing" class="text-blue-600 hover:underline">Box Sizing and Visibility →</a></p>
        </div>
    </article>
</main>

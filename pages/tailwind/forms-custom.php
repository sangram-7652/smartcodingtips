...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Apply padding, spacing, and custom styles directly to labels for styling:</p>
...
&lt;/label&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">You can visually hide the native input and style a custom span:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm"><code>
...
&lt;/label&gt;
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Use the same strategy for radio buttons using Tailwind’s <code>peer</code> and custom divs:</p>
            <pre class="bg-gray-100 p-4 rounded overflow-x-auto text-sm"><code>
&lt;label class="inline-flex items-center cursor-pointer space-x-2"&gt;
...
plugins: [
  require('@tailwindcss/forms'),
        ...
        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="tailwind.php?page=tailwind/forms-labels" class="text-blue-600 hover:underline">Floating Labels →</a></p>
        </div>
    </article>
</main>

...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <p class=" mb-2">Tailwind includes several built-in <code>z-*</code> utilities:</p>
...
&lt;/div&gt;
            ...
            <p class=" mt-2">Box B (z-20) will appear above Box A (z-10).</p>
        </section>
  ...
  theme: {
    extend: {
      zIndex: {
        ...
        <div class="mt-4">
            <p class=" font-semibold">Next: <a href="tailwind.php?page=tailwind/transform" class="text-blue-600 hover:underline">Transform & Scale →</a></p>
        </div>
    </article>
</main>

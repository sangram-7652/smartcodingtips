...
<main class="content-area" style="padding: 20px; max-width: 950px; margin: auto;">
    ...
    <article>
        ...
        <section class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-4 bg-gray-100 p-4 rounded text-sm">
        ...
        <section class="mb-6">
            ...
            <p class="text-lg mb-2">Here’s a semantic structure styled entirely with Tailwind:</p>
...
&lt;/article&gt;
        ...
        <div class="mt-4">
            <p class="text-lg font-semibold">Next: <a href="tailwind.php?page=tailwind/variants" class="text-blue-600 hover:underline">Responsive, Hover, and Focus Variants →</a></p>
        </div>
    </article>
</main>

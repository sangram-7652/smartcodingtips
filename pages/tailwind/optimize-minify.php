...
npx tailwindcss init -p
            ...
            <p class=" mt-2">This creates both a <code>tailwind.config.js</code> and <code>postcss.config.js</code> file.</p>
        </section>
...
module.exports = {
  plugins: {
    ...
    autoprefixer: {},
            ...
            <p class=" mt-2">Autoprefixer ensures browser compatibility by adding vendor prefixes.</p>
        </section>

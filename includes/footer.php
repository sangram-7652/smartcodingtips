...
<footer class="bg-gray-900 dark:bg-gray-800 text-white mt-10">
  <div class="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
    ...
    <div class="flex flex-wrap justify-center gap-4 text-sm text-gray-300">
      <a href="/smartcodingtips/about.php" class="hover:text-emerald-300 transition">About</a>
      <a href="/smartcodingtips/contact.php" class="hover:text-emerald-300 transition">Contact</a>
      <a href="/smartcodingtips/privacy-policy.php" class="hover:text-emerald-300 transition">Privacy Policy</a>
    </div>
